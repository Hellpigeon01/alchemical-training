	...
	<div class="container">
		<div class="testimonial">
			<p>
				...
				runner and found my health benefits on the trails. I knew that weightlifting was important
				and would help me stay strong and mobile as I entered my middle years.
				<br /><br />
				After a quick training assessment interview at Momentum, I was paired with Abigail. She took
				me under her wing and without hesitation began guiding me along my fitness journey.
				<br /><br />
				In May, we will celebrate our 4 year anniversary! Abigail is one of the most intuitive, intelligent,
				driven and supportive trainers! As my goals have shifted over the years, she has supported and
				shifted with me. She always offers me advice and encouragement, changes the direction of my workouts
				to suit my goals and keeps me challenged appropriately! She truly understands muscle mechanics!
				<br /><br />
				As a biology major myself, it is truly incredible to hear her analysis and rational for specific
				movements! Beyond training, Abigail has become a wonderful friend. She has the ability to know
				where I am physically and mentally each and every time I walk into the gym! She keeps me accountable
			...
			<div>
				<div>
					<p>
						...
						have dealt with injuries on and off that had prevented me from competing at times. I
						started working with Abigail a year ago and the transformation I've gone through has
						been even better than I ever imagined. Staying injury-free and racing better than I have
						in the last 7+ years is all from working with Abigail. I know that I wouldn't be able to
		...
		<div class="testimonial">
			<div>
				<p>
					"I can't say enough good things about Abigail. From the minute we signed Hunter up until
					now she has always focused on making him a better athlete focusing on both his strengths
					and weaknesses.
					<br /><br />
					Not only does he have fun with her, but she challenges him to get better, stronger, and has
					encouraged and guided him with improving his nutrition. Hunter always looks forward to sessions
					with Abigail and always asks to add more. She is very relatable to the boys and is also their
					biggest cheerleader. She has come to games and taken notes on what they need to improve on
					in the gym to improve in their sport.
					<br /><br />
					Hunter has gained great strength and mobility that has improved his hitting, throwing, and
					leg strength as a catcher. He has improved on his “pop” and throw down times as a catcher working
					with Abigail. Hunter struggled with speed when he first went to Abigail. He has gotten faster
					on the bases and continues to improve each season.
					<br /><br />
					The group of boys love Abigail and she really connects with them and is flexible with their
					almost impossible schedules. Hunter really respects her and always looks forward to their sessions.
					As a young teen it can be hard to motivate kids to want to work out. No motivation needed to
...
<style>
	...
	@media (max-width: 800px) {
		.testimonial {
			flex: 1 1 100%; /* Wraps to one column on smaller screens */
		}
		.heading {
			font-size: 2rem;
		}
